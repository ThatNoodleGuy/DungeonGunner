...
public class PlayerDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Player runtimme animator controller")]
    #endregion
    ...
    #endregion
    public Sprite playerMinMapIcon;
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckNullValue(this, nameof(playerMinMapIcon), playerMinMapIcon);
